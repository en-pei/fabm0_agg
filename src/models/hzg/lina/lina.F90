...
contains
 ...
 subroutine initialize(self,configunit)
   ...
   call self%get_parameter(self%lina_eN,'eN','mol-N m-3','external Nitrogen', default=-999.99_rk)
   call self%get_parameter(self%lina_eP,'eP','mol-P m-3', 'external Phosphorus', default=-999.99_rk)   
   call self%get_parameter(self%lina_gamma_starN,'gamma_starN','mol-N mol-C-1','Maximum Nitrogen uptake rate', default=-999.99_rk)  
   call self%get_parameter(self%lina_gamma_starP,'gamma_starP','mol-P mol-C-1','Maximum Phosphorous uptake rate', default=-999.99_rk)  
   call self%get_parameter(self%lina_AN,'AN','Nitrogen uptake affinity', default=-999.99_rk)  
   call self%get_parameter(self%lina_AP,'AP','Phosphorous uptake affinity', default=-999.99_rk) 
...
!  endif
  ...
  function lina_colimitation(qi,qj,n,cn) result(c)
     ...
     !real(rk)  :: cn1
      ...
      c=qi*lina_gn(qj/qi,n)*(1.0_rk+qi*qj*n+(1.0_rk/(4.0_rk*n) − 1.0_rk/2.0_rk))
