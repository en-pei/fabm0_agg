...
contains
 ...
 subroutine initialize(self,configunit)
   ...
   call self%get_parameter(self%lina_rhol, 'rohl','kg m-3','Density of Lithogenous',default=-999.99_rk)
   call self%get_parameter(self%lina_rhow, 'rohw','kg m-3','Density of Water',default=1025.00_rk)
