...
contains
 ...
 subroutine initialize(self,configunit)
   ...
   call self%get_parameter(self%lina_AN,'Nitrogen uptake affinity', default=-999.99_rk)  
   call self%get_parameter(self%lina_AP,'Phosphorous uptake affinity', default=-999.99_rk) 
   call self%get_parameter(self%lina_B, 'B','d', 'EPS production parameter', default=-999.99_rk) 
   call self%get_parameter(self%lina_g, 'g','m/s2', 'gravitational acceleration', default=9.81_rk) 
