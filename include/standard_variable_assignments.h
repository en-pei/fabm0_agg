...
standard_variables%dh_growth%name = 'dh_growth'
standard_variables%dh_growth%units = 'm s-1'

standard_variables%ice_area_fraction%name = 'ice_area_fraction'
standard_variables%ice_area_fraction%units = '1'

standard_variables%ice_conc%name = 'ice_conc'
standard_variables%ice_conc%units = '1/1'
