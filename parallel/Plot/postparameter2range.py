...
lay=16 #6 #4 #16 #layer for SPM concentration
laysize=9 #6 #4 #9 #layer for ESD
...
tsmdatat=bale3500spmc[8:,0]-0.95-0.1 # oszspmmay[:,0]+6-0.3 #+7 #-0.42 #datatime #tmzspmjuly[:,0]+7.5 #oszspmfeb[:,0] #tmzspmfeb[:-1,0]+4+6 #
d50datat=bale3500d50[8:,0]-0.95-0.1  # oszd50may[:,0]+6-0.3 #+7 #-0.42 #s1datatime #tmzd50july[:,0]+7.5 #oszd50feb[:,0] #tmzd50feb[:,0]+4+6 #
flowdatat=bale3500d50f[8:,0]-0.95-0.1 # oszflowmay[:,0]+6-0.3 #+7 #-0.42 #tmzflowjuly[:,0]+7.5 #oszflowfeb[:,0] #tmzflowfeb[:,0]+4+6 #
#flowdatat1=bale3500spmcf[:,0]-0.95-0.1#-0.42 

tsmdata=bale3500spmc[8:,1] #oszspmmay[:,1] #dataspmc #tmzspmjuly[:,1] #oszspmfeb[:,1] #tmzspmfeb[:-1,1] #
d50data=bale3500d50[8:,1] #oszd50may[:,1] #s1datasize #tmzd50july[:,1] #oszd50feb[:,1]  #tmzd50feb[:,1] #
flowdata=bale3500d50f[8:,1] # oszflowmay[:,1] #tmzflowjuly[:,1] #oszflowfeb[:,1] #tmzflowfeb[:,1] #
