...
##this version not relative error but absolute error, avoid division#######
...
filelist=[]
path='/gpfs/home/lie/setups/bale2002/testoszfeb'

lay=6 #4 #16 #layer for SPM concentration
laysize=6 #4 #9 #layer for ESD
...
tsmdatat=oszspmfeb[:,0]+6+1 #oszspmmay[:,0]+6-0.3 #+7 #bale3500spmc[:,0]-0.95-0.1#-0.42 #datatime #tmzspmjuly[:,0]+7.5 #tmzspmfeb[:-1,0]+4+6 #
d50datat=oszd50feb[:,0]+6+1 #oszd50may[:,0]+6-0.3 #+7 #bale3500d50[:,0]-0.95-0.1#-0.42 #s1datatime #tmzd50july[:,0]+7.5 tmzd50feb[:,0]+4+6 #
flowdatat=oszflowfeb[:,0]+6+1 # oszflowmay[:,0]+6-0.3 #+7 #bale3500d50f[:,0]-0.95-0.1#-0.42 #tmzflowjuly[:,0]+7.5 tmzflowfeb[:,0]+4+6 #
#flowdatat1=bale3500spmcf[:,0]-0.95-0.1#-0.42 

tsmdata=oszspmfeb[:,1] #oszspmmay[:,1] #bale3500spmc[:,1] #dataspmc #tmzspmjuly[:,1] #tmzspmfeb[:-1,1] #
d50data=oszd50feb[:,1]  #oszd50may[:,1] #bale3500d50[:,1] #s1datasize #tmzd50july[:,1] #tmzd50feb[:,1] #
flowdata=oszflowfeb[:,1] #oszflowmay[:,1] #bale3500d50f[:,1] #tmzflowjuly[:,1] #tmzflowfeb[:,1] #
