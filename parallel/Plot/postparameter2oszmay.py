...
filelist=[]
path='/gpfs/home/lie/setups/bale2002/test2'
...
tsmdatat=oszspmmay[:,0]+6-0.3 #+7 #bale3500spmc[:,0]-0.95-0.1#-0.42 #datatime #tmzspmjuly[:,0]+7.5 #oszspmfeb[:,0] #tmzspmfeb[:-1,0]+4+6 #
d50datat=oszd50may[:,0]+6-0.3 #+7 #bale3500d50[:,0]-0.95-0.1#-0.42 #s1datatime #tmzd50july[:,0]+7.5 #oszd50feb[:,0] #tmzd50feb[:,0]+4+6 #
flowdatat=oszflowmay[:,0]+6-0.3 #+7 #bale3500d50f[:,0]-0.95-0.1#-0.42 #tmzflowjuly[:,0]+7.5 #oszflowfeb[:,0] #tmzflowfeb[:,0]+4+6 #
#flowdatat1=bale3500spmcf[:,0]-0.95-0.1#-0.42 

tsmdata=oszspmmay[:,1] #bale3500spmc[:,1] #dataspmc #tmzspmjuly[:,1] #oszspmfeb[:,1] #tmzspmfeb[:-1,1] #
d50data=oszd50may[:,1] #bale3500d50[:,1] #s1datasize #tmzd50july[:,1] #oszd50feb[:,1]  #tmzd50feb[:,1] #
flowdata=oszflowmay[:,1] #bale3500d50f[:,1] #tmzflowjuly[:,1] #oszflowfeb[:,1] #tmzflowfeb[:,1] #
