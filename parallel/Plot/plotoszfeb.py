...
path='/gpfs/work/lie/run/par/6oszfeb'  #linked best run from parameterauto.sh
...
##define dataset
tsmdatat=oszspmfeb[:,0]+6+1 #tmzspmjuly[:,0]+7.5 # bale3500spmc[:,0]-0.95-0.1-0.6 #bale3500spmc[8:,0]-0.95-0.1-0.6 # oszspmmay[:,0]+6-0.3 #+7 #tmzspmjuly[:,0]+7.5 #-0.42 #datatime #tmzspmfeb[:-1,0]+4+6 #

d50datat=oszd50feb[:,0]+6+1 #tmzd50july[:,0]+7.5 #bale3500d50[:,0]-0.95-0.1-0.6 #bale3500d50[8:,0]-0.95-0.1-0.6 #oszd50may[:,0]+6-0.3 #+7 #tmzd50july[:,0]+7.5 #-0.42 #s1datatime #tmzd50feb[:,0]+4+6 #
flowdatat=oszflowfeb[:,0]+6+1 #tmzflowjuly[:,0]+7.5 #bale3500spmcf[:,0]-0.95-0.1-0.6#bale3500d50f[8:,0]-0.95-0.1-0.6# oszflowmay[:,0]+6-0.3 #+7 #tmzflowjuly[:,0]+7.5 #-0.42 #tmzflowfeb[:,0]+4+6 #
#flowdatat1=bale3500spmcf[:,0]-0.95-0.1 #-0.42

tsmdata=oszspmfeb[:,1] #tmzspmjuly[:,1] #bale3500spmc[0:,1] ##bale3500spmc[8:,1] #oszspmmay[:,1] #tmzspmjuly[:,1] #dataspmc #tmzspmfeb[:-1,1] #
d50data=oszd50feb[:,1]  #tmzd50july[:,1] #bale3500d50[0:,1] ##bale3500d50[8:,1] #oszd50may[:,1] #tmzd50july[:,1] #s1datasize #tmzd50feb[:,1] #
flowdata=oszflowfeb[:,1] #tmzflowjuly[:,1] #bale3500spmcf[0:,1] ##bale3500d50f[8:,1] #oszflowmay[:,1] #tmzflowjuly[:,1]#tmzflowfeb[:,1] #
...
axs[2].plot(flowdatat,flowdata,'o',color='grey',alpha=0.5,label='OSZ Feb') #'F&L TMZ July' /100 for labdata
