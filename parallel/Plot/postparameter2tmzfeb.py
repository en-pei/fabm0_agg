...
path='/gpfs/home/lie/setups/bale2002/test1'
...
tsmdatat=tmzspmfeb[:-1,0]+4+6+0.72 #tmzspmjuly[:,0]+7.5 ##bale3500spmc[8:,0]-0.95-0.1 # oszspmmay[:,0]+6-0.3 #+7 #-0.42 #datatime #oszspmfeb[:,0] #
d50datat=tmzd50feb[:,0]+4+6+0.72 #tmzd50july[:,0]+7.5 #bale3500d50[8:,0]-0.95-0.1  # oszd50may[:,0]+6-0.3 #+7 #-0.42 #s1datatime #oszd50feb[:,0] #
flowdatat=tmzflowfeb[:,0]+4+6+0.72 #tmzflowjuly[:,0]+7.5 #bale3500d50f[8:,0]-0.95-0.1 # oszflowmay[:,0]+6-0.3 #+7 #-0.42 #oszflowfeb[:,0] #
#flowdatat1=bale3500spmcf[:,0]-0.95-0.1#-0.42 

tsmdata=tmzspmfeb[:-1,1] #tmzspmjuly[:,1] #bale3500spmc[8:,1] #oszspmmay[:,1] #dataspmc #oszspmfeb[:,1] #
d50data=tmzd50feb[:,1] #tmzd50july[:,1] #bale3500d50[8:,1] #oszd50may[:,1] #s1datasize #oszd50feb[:,1]  #
flowdata=tmzflowfeb[:,1] #tmzflowjuly[:,1] #bale3500d50f[8:,1] # oszflowmay[:,1] #oszflowfeb[:,1] #
